...
public class UserService{
    ...
    public String format(UserDTO userDTO){
        return "Username: " + userDTO.username() + "\n" +
                "Type: " + userDTO.type() + "\n" +
                "Loan History: " + formatHistory(userDTO.borrowedBooksHistory()) + "\n" +
                "Reservation History: " + formatHistory(userDTO.reservationHistory()) + "\n" +
                "Ratings: " + formatHistory(userDTO.ratings()) + "\n";
    }

    private String formatHistory(List<BookDTO> bookDTOS) {
        return bookDTOS.stream().map(bookDTO -> '\n'+bookService.format(bookDTO) + '\n').toList().toString();
    }
